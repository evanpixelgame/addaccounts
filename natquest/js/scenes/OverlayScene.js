    ...
    updateActiveScene = (newSceneKey) => {
        ...
        this.scene.manager.scenes.forEach(scene => {
            if (scene.scene.key === newScene) {
                ...
                console.log(``)
                console.log(this.activeScene);
                console.log(this.activeScene.scene.key);
            }
        });
    }
